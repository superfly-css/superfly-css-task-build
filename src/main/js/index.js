...
var postcss_apply = require('postcss-apply');
var postcss_reporter = require('postcss-reporter');
var autoprefixer = require('autoprefixer');

var PLI = require('superfly-css-pli');

var processors = [postcss_import, postcss_each, postcss_custom_properties, postcss_apply, postcss_calc, postcss_color_function, autoprefixer, postcss_reporter({
  clearMessages: true
})];
